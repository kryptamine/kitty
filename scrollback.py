...
def pipe_data(w, target_window_id, config, kitty_path, tmux_data):
    ...
    return {
        ...
        "kitty_opts": {
            ...
            "shell_integration": kitty_shell_integration,
            "scrollback_fill_enlarged_window": kitty_opts.scrollback_fill_enlarged_window,
            "scrollback_lines": kitty_opts.scrollback_lines,
            "scrollback_pager": kitty_opts.scrollback_pager,
            "allow_remote_control": kitty_opts.allow_remote_control,
            "listen_on": kitty_opts.listen_on,
            "scrollback_pager_history_size": kitty_opts.scrollback_pager_history_size,
        },
    ...
    if w is not None:
        ...
        if not kitty_path:
            boss.show_error(
                ...
                cmd_not_found_error.substitute(cmd="kitty") + open_an_issue_msg,
            )
            return
        ...
        kitty_data_str = pipe_data(w, target_window_id, config, kitty_path, tmux_data)
